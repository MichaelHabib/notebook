= Wordpress Beginner Guide 2019-2020
...
- https://profiles.wordpress.org/michaelhabib16#content-favorites[Check Michael habib's Favorited items on wordpress.org]
...
alias wp='./wp-cli.phar' &> wp.bashalias
----
to use `wp [OPTIONS]` in the terminal, run `source ./wp.bashlais` .
...
=== Cafe Software Plugin

=== Booking Software Plugin 

=== eListing Software Plugin
